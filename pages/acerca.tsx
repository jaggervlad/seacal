  ...
  <MainLayout title="Acerca - Sebastian Acosta">
    <div className="mx-auto flex max-w-2xl flex-col items-start justify-center pb-16">
      ...
      <p className="mb-4 text-base font-medium text-slate-600 dark:text-slate-400 md:text-lg">
        Hola soy programador, padre y deportista. Trabajo como Desarrollador Web
        Full Stack (Freelance).
      </p>

      <p className="mb-4 text-base font-medium text-slate-600 dark:text-slate-400 md:text-lg">
        Tengo conocimientos tanto en el frontend como el backend, disfruto mucho
        de aprender nuevas tecnologias, buenas prácticas de desarrollo, patrones

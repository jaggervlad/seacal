const BackendSection: React.FC = () => (
  <div>
    <h4 className="mb-1 text-2xl font-extrabold tracking-tight text-black dark:text-white md:text-4xl">
      Backend
    </h4>

    <p className="mb-6 text-slate-600 dark:text-slate-400">
      Node.js y Typescript para crear servidores con comunicación HTTP, para
      servir API`s Rest con Express, y Graphql con Apollo Server y GraphqlTools.
    </p>
